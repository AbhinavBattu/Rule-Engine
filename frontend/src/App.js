...
//   const [ast, setAst] = useState(null); // New state variable for AST

//   const handleCreateAST = async () => {
//     try {
//       const cleanedQuery = query
//         .replace(/^\[|\]$/g, '') // Remove outer brackets
//         .split(/\)\s*,\s*\(/)   // Split by ")),(" while accounting for spaces
...
//       alert(`AST created successfully with ID: ${response.data.ruleId}`);
//     } catch (error) {
//       console.error(error);
//       alert('An error occurred while creating the AST. Please check your input and try again.');
//     }
//   };
...
//         alert('Invalid JSON format in the data input. Please correct it and try again.');
//       } else {
//         console.error(error);
//         alert('An error occurred while evaluating the data. Please check your input and try again.');
//       }
//     }
//   };
